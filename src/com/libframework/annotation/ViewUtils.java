...
package com.libframework.annotation;
...
import com.libframework.annotation.PreferenceInject;
import com.libframework.annotation.ResInject;
import com.libframework.annotation.ViewInject;
import com.libframework.annotation.helper.EventListenerManager;
import com.libframework.annotation.helper.ResLoader;
import com.libframework.annotation.helper.ViewFinder;
import com.libframework.annotation.helper.ViewInjectInfo;
import com.libframework.annotation.event.EventBase;
                        ...
                        if (annType.getAnnotation(EventBase.class) != null) {
                            ...
                            try {
                                ...
                                for (int i = 0; i < len; i++) {
                                    ...
                                    if (parentIdsLen > i) {
                                    	info.parentId = (Integer) Array.get(parentIds, i);
									} else {
										info.parentId = 0;
									}
